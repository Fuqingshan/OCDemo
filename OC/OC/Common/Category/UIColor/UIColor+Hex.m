...
+ (UIColor *)lk_alphaColorWithHexString:(NSString *)alphaColor {
    ...
    if ([cString length] == 6) {
        return [UIColor lk_colorWithHexString:cString];
        ...
        return [UIColor lk_colorWithHexString:colorString alpha:alpha / 255.f];
    } else {
        return [UIColor clearColor];
    }
}
...
+ (UIColor *)lk_colorWithHexString:(NSString *)color {
    return [self lk_colorWithHexString:color alpha:1.0f];
}
