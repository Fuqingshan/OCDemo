...
//当UIKit在后台线程使用时会产生断言（ps：为毛放在客服的文件夹里面）
...
static void PSPDFAssertIfNotMainThread(void) {
    //    PSPDFAssert(NSThread.isMainThread, @"\nERROR: All calls to UIKit need to happen on the main thread. You have a bug in
    //    your code. Use dispatch_async(dispatch_get_main_queue(), ^{ ... }); if you're unsure what thread you're in.\n\nBreak on
    //    PSPDFAssertIfNotMainThread to find out where.\n\nStacktrace: %@", [NSThread callStackSymbols]);
}
