...
#import "Runloop3ViewController.h"
#import "FluencyMonitor.h"

@interface Runloop3ViewController ()<UITableViewDelegate,UITableViewDataSource>
@property (weak, nonatomic) IBOutlet UITableView *tableView;

@end

@implementation Runloop3ViewController
